...
3.  **画像アップロード**:
    ...
    *   Bloggerで新しい記事を選び、フォルダ内の画像を貼り付けてください。
...
5.    **記事アップロード**
    *   記事が自動投稿をします。
    *   自動投稿が完了するとBloggerの下書きになっていますので、確認し**公開**して下さい
...
- **[クイックスタート](docs/QUICKSTART_jp.md)** - 5分でセットアップ
- **[セットアップガイド](docs/SETUP_jp.md)** - Google Cloud & Blogger API設定
- **[アーキテクチャ](docs/ARCHITECTURE.md)** - プロジェクト構造の詳細
- **[トラブルシューティング](docs/TROUBLESHOOTING_jp.md)** - よくある問題と解決方法
